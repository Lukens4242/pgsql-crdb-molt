...
# 1. Start Postgres
# ========================
echo "🚀 [1/12] Starting Postgres container..."
...
# ========================
echo "🛠️  [2/12] Configuring PostgreSQL for logical replication..."
...
# ========================
echo "✅ [3/12] Verifying PostgreSQL replication settings..."
...
# ========================
echo "📦 [4/12] Inserting test orders into Postgres..."
...
# ========================
echo "📄 [5/12] Dumping schema to $SCHEMA_FILE..."
mkdir -p "$SCHEMA_DIR"
...
# ========================
echo "🪵 [6/12] Creating CockroachDB certificates..."
rm -f index.txt* serial.txt* ./certs/*
...
# 7. Start CockroachDB
# ========================
echo "🪵 [7/12] Starting CockroachDB container..."
...
# ========================
echo "🔁 [8/12] Converting schema for CockroachDB using molt..."
podman run --rm \
...
# ========================
echo "📥 [9/12] Applying converted schema to CockroachDB..."
...
# ========================
echo "🔍 [10/12] Verifying CockroachDB schema..."
...
# ========================
echo "🚚 [11/12] Running molt fetch with data + replication..."
podman run --rm -it \
